...
function MiniRing({ progress }: { progress: number }) {
  ...
  return (
    <svg width="108" height="108" viewBox="0 0 108 108" fill="none">
      ...
      <circle
        cx="54" cy="54" r="48"
        stroke="url(#miniGrad)" strokeWidth="5" fill="none"
        strokeLinecap="round"
...
export function AppMockup() {
  ...
  return (
    <section id="mockup" className="section" style={{ background: 'var(--bg-primary)' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginTop: 28 }}>
            {[
              ...
              { icon: '⏱', text: 'Focus timer with Deep, Flow, Sprint, and Custom modes' },
            ].map(({ icon, text }) => (
          ...
          <div style={{
            ...
            <div style={{ padding: '12px 16px 6px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', gap: 4 }}>
                {[4, 4, 4].map((_, i) => (
                  <div key={i} style={{ width: 4, height: 4, borderRadius: '50%', background: '#4d4354' }} />
                ))}
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: 'rgba(183,109,255,0.10)', borderRadius: 99,
                padding: '3px 8px', border: '1px solid rgba(221,183,255,0.25)',
              }}>
            ...
            {/* Content */}
            <div style={{ padding: '10px 10px 6px', display: 'flex', flexDirection: 'column', gap: 8, flex: 1 }}>
              {/* Hero card */}
              <div style={{
